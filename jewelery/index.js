const div = document.querySelector("#jewelery");
...
async function showJewelery() {
  try {
    const jeweleries = await myFetch(
      "https://fakestoreapi.com/products/category/jewelery"
    );

    for (let i = 0; i < jeweleries.length; i++) {
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6">
                    <h5 style="text-align:left;">${jeweleries[i].title}</h5>
                    <p class="mb-4 mb-md-0" style="text-align:left;">
                      ${truncateString(jeweleries[i].description, 150)}
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <div class="d-flex justify-content-center align-items-center mb-1">
                      <h4 class="mb-1 me-1">${jeweleries[i].price}€</h4>
                    </div>
