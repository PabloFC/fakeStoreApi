...
const div = document.getElementById("womens");
...
async function showWomens() {
  try {
    const womens = await myFetch(
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6">
                    <h5 style="text-align:left;">${womens[i].title}</h5>
                    <p class="mb-4 mb-md-0" style="text-align:left;">
                      ${truncateString(womens[i].description, 150)}
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <div class="d-flex justify-content-center align-items-center mb-1">
                      <h4 class="mb-1 me-1">${womens[i].price}€</h4>
                    </div>
